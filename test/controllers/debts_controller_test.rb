...
class DebtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post debts_url, params: { debt: { amount: @debt.amount, category_id: @debt.category_id, description: @debt.description } }
    end
  ...
  test "should update debt" do
    patch debt_url(@debt), params: { debt: { amount: @debt.amount, category_id: @debt.category_id, description: @debt.description } }
